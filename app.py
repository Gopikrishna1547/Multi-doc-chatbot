...
def render_sidebar():
    with st.sidebar:
        st.title("📂 Documents")
        st.markdown("Upload PDFs and ask questions based only on uploaded documents.")
        st.divider()
...
def render_chat():
    ...
    st.caption("Upload PDFs, generate summaries, create important questions, and ask document-based questions.")
    ...
    if not st.session_state.documents_loaded:
        ...
        - Generate a concise PDF summary
        - View important questions and answers
        - Ask your own questions
        - Get answers only from uploaded PDFs
        """)
        return
